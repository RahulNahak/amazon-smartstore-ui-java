...
<body>
	...
	<form action="/SmartStore/generateQRCode" method="POST" name="form1">
		<div>
		<div
			...
			<span style="font-family: 'Roboto', sans-serif; "><b>List of all
				...
				Phone number:&nbsp;<input type="text" name="phoneNumber" value="8976698602"><br><br>
				Amount:&nbsp;<input type="number" name="amount" value="10000" required><br><br>
				Sandbox:&nbsp;<input type="text" name="Sandbox" value="Y" required><br><br>
				<span style="font-family: 'Roboto', sans-serif; border: #C8C8C8; ">
				<b>Catalogue details</b></span><br>
				skuCode:&nbsp;<input type="number" name="skuCode" value="3126326" required><br><br>
				ASIN:&nbsp;<input type="number" name="ASIN" value="34284771" required><br><br>
				unitPrice:&nbsp;<input type="number" name="unitPrice" value="3" required><br><br>
				brand:&nbsp;<input type="text" name="brand" value="Samsung" required><br><br>
				productNote:&nbsp;<input type="text" name="productNote" value="Mobile" required><br><br>
				uniqueIdentifierStatus:&nbsp;<input type="text" name="uniqueIdentifierStatus" value="Valid" required><br><br>
				uniqueIdentifierType:&nbsp;<input type="text" name="uniqueIdentifierType" value="Flag" required><br><br>
				uniqueIdentifier:&nbsp;<input type="text" name="uniqueIdentifier" value="Flag" required><br><br>
				customerFriendlyBillPageMessage:&nbsp;<input type="number" name="customerFriendlyBillPageMessage" value="75742" required><br><br>
				transactionTimeout:&nbsp;<input type="text" name="transactionTimeout:" value="180" required><br><br>
				isLoyalCustomer:&nbsp;<input type="text" name="isLoyalCustomer" value="Y" required><br><br>
