...
<body>
	...
	<form action="/amazon-smat-store-ui-java/generateQRCode" method="POST" name="form1" id="generateQRCode">
		<div>
		<div
			...
			<span style="font-family: 'Roboto', sans-serif; "><b>List of all Parameters</b></span><br><br>
				...
				<input type="text" name="signatureMethod" value="10000" required><br><br>
				...
				<input type="text" name="skuCode" value="Store_123" required><br><br>
				
				<label>Store ID Type:</label>&nbsp;
				<input type="text" name="skuCode" value="type" required><br><br>
				
				<label>Terminal ID:</label>&nbsp;
				<input type="text" name="skuCode" value="12df" required><br><br>
				
				<label>Store Name:</label>&nbsp;
				<input type="text" name="skuCode" value="ForumMart" required><br><br>
				
				<label>Brand:</label>&nbsp;
				<input type="text" name="skuCode" value="PUMA" required><br><br>
