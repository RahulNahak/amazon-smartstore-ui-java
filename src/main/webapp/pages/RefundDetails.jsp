...
<body>
	...
	<div style="margin-top: -5%;">
		<span style="font-family: 'Roboto', sans-serif;"><b>Get Refund Details</b></span><br>
	</div>
	...
	<form action="/SmartStore/refundDetails" method="Get" name="form1">
		<div>
		<div
			...
			<span style="font-family: 'Roboto', sans-serif; "><b>List of all
				...
				Amazon Refund ID&nbsp;<br><input type="text" name="amazonRefundId" value="TRAN456" required><br><br>
